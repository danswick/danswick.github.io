...
// empty array to house categorical 
var ddsCategories = [];
...
// if visited, return 0. To be used for rgba alpha channel value)
...
function categoricalHash(feature) {
    var visitedVal = isVisited(feature);
}
